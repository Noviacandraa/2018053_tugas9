...
import static com.example.tugas5_2018053.DBmain.TABLENAME;
...
import com.example.tugas5_2018053.databinding.ActivityMain2Binding;
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rec != null) {
                    Toast.makeText(MainActivity2.this, "Data Inserted", Toast.LENGTH_SHORT).show(); binding.edtname.setText("");
